...
function set()
{
    getElementsByTagName("TextBox")[0].onclick = "event.cancelBubble = true; this.select(); lcs(this)";
    getElementsByTagName("TextBox")[0].onfocus = "this.select(); lcs(this)";
}
...
document.write('<tr style="background:#FF9900;font:12px Arial;color:#FFFFFF"><td align=center>1</td><td align=center>2</td><td align=center>3</td><td align=center>4</td><td align=center>5</td><td align=center>6</td><td align=center>7</td></tr>');
